...
console.log(yearsUntilRetirement(1991, 'Shin'));
...
const interestedIn = prompt('What do you want to know about Jonas? Choose betwwen firstName, lastName, age, job, and friends');
...
for (let excercise = 1; excercise < 4; excercise++){
  ...
  for (let rep = 1; rep < 6; rep++) {
    console.log(`------ Excercise ${excercise}: Lifting weight repetiton ${rep} 🏋️‍♀️`);
  }
}
